...
public class Engine_ArrayTests
{
    ...
    {
        engine.ApplySource(new ("id1"), new ( new ( "source1"), "{\"Names\":[\"Name1\"]}"));
        engine.ApplySource(new ("id1"), new ( new ( "source2"), "{\"Names\":[\"Name1\",\"Name2\"]}"));
    ...
    {
        engine.ApplySource(new ("id1"),new (new ( "source1"), "{\"Names\":[\"Name1\",\"Name2\"]}"));
        engine.ApplySource(new ("id1"),new (new ( "source2"), "{\"Names\":[\"Name1\"]}"));
